...
seasonyr_order <- c("Spring 2016", "Summer 2016", "Fall 2016", "Winter 2016-2017", "Spring 2017", 
                    "Summer 2017", "Fall 2017", "Winter 2017-2018", "Spring 2018",
                    "Summer 2018", "Fall 2018", "Winter 2018-2019", "Spring 2019", 
                    "Summer 2019", "Fall 2019", "Winter 2019-2020", "Spring 2020",
                    "Summer 2020", "Fall 2020", "Winter 2020-2021", "Spring 2021")

cmtx_longer2 <- cmtx_avgs %>% 
    pivot_longer(cols = chloro:pras, names_to = "func_type", values_to = "conc") %>%
    filter(station != 60) %>% 
    mutate(season_year = case_when(season == "Fall"~ paste0(season," ",as.character(year)),
...
new.row <- list(season_year="Summer 2016", station = "3")
cmtx_longer2[nrow(cmtx_longer2) + 1, names(new.row)] <- new.row

new.row2 <- list(season_year="Winter 2016-2017", station = "3")
cmtx_longer2[nrow(cmtx_longer2) + 1, names(new.row)] <- new.row2

new.row3 <- list(season_year="Spring 2020", station = "3")
...
#chemtax stacked bar graph (not ratio), organized by statio
