...
df5 <-
    ...
    mutate(
        ...
        ## in the date_extracted_month_day_year column, most of the cells are in date format in the excel
        ## but the first cell has the word "box" in it, so when I read the file into r the whole column 
        ## is in character format, and the dates are completely reformatted. Line 191 converts the "box"
        ## to NA, but the rest of the dates are still messed up and I'm not sure how to make them dates again
    )
