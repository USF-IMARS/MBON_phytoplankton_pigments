...
lat_lon_dat <- 
  ...
  filter(
      ...
      & !str_detect(station, "21.5|9B|24|^3$")
...
stn_map <-
  base_map +
  geom_sf(data = ply_fknms, fill = NA, color = "red") +
  ...
  annotate(
    ...
    # angle       = c(35, 24, 15, -3),
    x           = c(-80.52, -81.1, -81.95),
    y           = c(24.84, 24.61, 24.49),
    angle       = c(35, 24, -3),
    label       = c(100, 50, 10),
    size        = 7,
    # fontface    = "bold",
  ...
  annotate(
    geom        = "text",
    x           = c(-80.75, -81.0, -80.75, -80.25),
    y           = c(25.06, 24.4, 25.5, 25.55),
...
fullmap <- 
  ggdraw() +
  draw_plot(stn_map) +
  draw_plot(inset_map, x = 0.06, y = 0.59, width = 0.2, height = 0.45)
fullmap
