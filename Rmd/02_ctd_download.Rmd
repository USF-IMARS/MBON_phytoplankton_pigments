...
# 4.0 Function to query and download CTD data from each cruise
...
# 5.0 Run ctd_downloads function and try each cruise ID for existing data
...
# 6.0 Read CTD files and average top 5 meters
...
save_csv(tibble(x = "d"),  
    ...
    save_name      = "ctd_all",
    overwrite      = FALSE,
    verbose        = TRUE, time_stamp_fmt = "help")
```
