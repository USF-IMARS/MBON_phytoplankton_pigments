...
if (identical(file.pig, character(0))) {
    message(glue("You may need to put raw HPLC data into a ", 
                 "newly created directory for raw HPLC data in ",
                 "{dir} (as of Jan 2023)"))
} else {
    file.pig
}
...
df2 <-
    ...
    mutate(indicate_if_filters_are_replicates = 
               as.character(indicate_if_filters_are_replicates)) %>%
    
    # fix gfc to gsfc
    rename(filter_storage_before_shipment_to_gsfc = 
