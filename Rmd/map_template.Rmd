...
set.seed(123)
krig_fuco      <-
    spatialProcess(as.matrix(df_fuco_loc),
...
if (min(ratio_kriged_fuco$z, na.rm = TRUE) < min(df_fuco$fuco_rat_avg, na.rm = TRUE)) {
...
mtext(expression(paste('Longitude (', degree, 'W)')), 1, line = 3, cex = 0.75)

mtext(expression(paste('Latitude (', degree, 'N)')), 2, line = 3, cex = 0.75)
