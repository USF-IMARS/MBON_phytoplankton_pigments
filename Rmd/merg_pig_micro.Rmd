...
taxa_nt_mt <- bind_cols(taxa_df, taxa_id_all) %>% 
...
# left_join by functional type to add avg conversion factors to data frame
# multiply conversion factors by counts to get converted counts
