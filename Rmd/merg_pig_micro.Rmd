...
ggplot(cmtx_micro, aes(x=cmtx_conc_dino, y=log(micro_conc_dino))) + 
           geom_point()
...
```{r}
cmtx_micro2 <- cmtx_micro %>% filter(!indx == "28-7")


blandr.draw(cmtx_micro2$cmtx_conc_cyano, cmtx_micro2$micro_conc_cyano, plotTitle = "Cyanobacteria")
blandr.draw(cmtx_micro2$cmtx_conc_crypto, cmtx_micro2$micro_conc_crypto, plotTitle = "Cryptophytes")
blandr.draw(cmtx_micro2$cmtx_conc_chloro, cmtx_micro2$micro_conc_chloro, plotTitle = "Chlorophytes")
blandr.draw(cmtx_micro2$cmtx_conc_pras, cmtx_micro2$micro_conc_pras, plotTitle = "Prasinophytes")
blandr.draw(cmtx_micro2$cmtx_conc_hapt, cmtx_micro2$micro_conc_hapt, plotTitle = "Haptophytes")
blandr.draw(cmtx_micro2$cmtx_conc_dino, cmtx_micro2$micro_conc_dino, plotTitle = "Dinoflagellates")
blandr.draw(cmtx_micro2$cmtx_conc_diat, cmtx_micro2$micro_conc_diat, plotTitle = "Diatoms")
```
