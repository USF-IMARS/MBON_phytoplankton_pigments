...
cmtx_env <- read.csv(paste0(path_out, "cmtx_env_data_for_cca.csv"))
...
cmtx_cca <- cca(cca_matrix ~ temp + o_sat + do + par + sal, data = env_cmtx, na.action = na.exclude)
plot(cmtx_cca)
autoplot(cmtx_cca, axes = c(6, 7))
summary(cmtx_cca)
