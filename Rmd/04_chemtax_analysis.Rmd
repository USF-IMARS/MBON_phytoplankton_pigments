...
## 4.3 Box Plot: Larger Dynamic Range PFTs
...
## 4.4 Box Plot: Smaller Dynamic Ranged PFTs
...
## 4.5 Save: Large and Small Range Boxplots

```{r save-plt}
save_gg(
  plt            = box_lg, 
  save_location  = dir_plt_save,
  save_name      = "cmtx_boxplot_lg",
  verbose        = TRUE,
  overwrite      = FALSE,  
