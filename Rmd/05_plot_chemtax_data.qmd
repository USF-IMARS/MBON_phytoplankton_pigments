...
- hapt8 is uslaly 7 - 15% of total chl-a
  - highest in winter 2018 - 2019 and 2020 - 2021 >17% of total chl-a
- chloro  tend to between 0 - 10% of total chl-a
  - peaks in winter then decresases towards 0% for the rest of the year
    ...
    plt =
      map2(
        ...
        ggnewscale::new_scale_fill() +
          ...
          geom_point(
            aes(y = sec$proj(total_chl_a), fill = season),
            # fill = "grey50",
            alpha = 0.5,
            size = 5,
            shape = 24,
...
tibble(
  ...
  mutate(
    ...
    ggplot(aes(x = r, y = transmittance)) +
    geom_point() +
    geom_point(
        data = tibble(r = c(0.1, 0.2),
                      transmittance = c(0.5, 0.25)),
        color = "red"
    )
